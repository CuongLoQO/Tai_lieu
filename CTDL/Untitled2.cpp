...
int main()
{
    ...
    // 3
    cout<<"\n3.Kich thuoc vector: "<<vecGetSize(vec);
    ...
    int y;
    IncreaseSort(vec2);
    cout<<"\nTao vector 2 va sap xep cac phan tu theo thu tu tang dan:"; output(vec2);
...
//Cat bo phan dung luong thua cua vector
void TrunCate(Vector & vec) {
    T * old = vec.array;
...
//Xoa tu vi tri pos1 den vi tri pos 2
void DeleteP1toP2(Vector & vec, int pos1, int pos2) {
